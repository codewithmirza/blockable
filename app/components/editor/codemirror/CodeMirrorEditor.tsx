...
import { filePath } from '~/lib/webcontainer';
import { filesStore } from '~/lib/stores/files';
import { chatStore } from '~/lib/stores/chat'; // Added import for chatStore
    ...
    .map((range) => {
      return {
        ...
        create: () => {
          ...
          divElement.innerHTML = '<div class="flex items-center"><div class="i-svg-spinners:90-ring-with-bg text-bolt-elements-loader-progress mr-2"></div>Cannot edit file while agent is responding</div>';
